<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/system\withdrawals.html";i:1562135653;s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\layout.html";i:1558323298;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="ncap-form-default">
            <!--<dl class="row">-->
                ...
                <!--<dd class="opt">-->
                    ...
                    <!--</div>-->
                    <!--<p class="notic">是否开启提现配置</p>-->
                <!--</dd>-->
            <!--</dl>-->

            <!--<dl class="row">-->
                <!--<dt class="tit">-->
                    <!--<label for="reg_integral">市运营商奖励设置</label>-->
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<p>店铺年费管理<input readonly="true" type="text" name="storeyear_fee" value="<?php echo $store_config['year_fee']; ?>">元/半年的<input name="store_year_cityreward" type="text" value="<?php echo $operator_config['store_year_cityreward']; ?>">%;</p>-->
                    <!--<p>店铺月费管理<input readonly="true" type="text" name="storemonth_fee" value="<?php echo $store_config['month_fee']; ?>">元的<input name="store_month_cityreward" type="text" value="<?php echo $operator_config['store_month_cityreward']; ?>">%;</p>-->
                    <!--<p> 店铺提现的<input name="store_withdraw_fee" value="<?php echo $store_config['withdraw_fee']; ?>" class="input-txt" type="text"> %中的<input id="service_ratio" name="store_withdrawals_cityreward" value="<?php echo $operator_config['store_withdrawals_cityreward']; ?>" class="input-txt" type="text"> %给予奖励</p>-->
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="reg_integral">县运营商奖励设置</label>
                </dt>
                <dd class="opt">
                    <p >店铺季费管理<input readonly="true" type="text" name="season_fee" value="<?php echo $store_config['season_fee']; ?>">元的<input name="store_season_reward" type="text" value="<?php echo $operator_config['store_season_reward']; ?>">%;</p>
                    <p>店铺半年管理<input readonly="true" type="text" name="mid_year_fee" value="<?php echo $store_config['mid_year_fee']; ?>">元的<input name="store_mid_year_reward" type="text" value="<?php echo $operator_config['store_mid_year_reward']; ?>">%;</p>
                    <p>店铺年费管理<input readonly="true" type="text" name="year_fee" value="<?php echo $store_config['year_fee']; ?>">元的<input name="store_year_reward" type="text" value="<?php echo $operator_config['store_year_reward']; ?>">%;</p>

                    <p>店铺提现的<input name="withdraw_fee" value="<?php echo $store_config['withdraw_fee']; ?>" class="input-txt" type="text"> %

                        中的<input id="service_ratio" name="store_withdrawals_operator_reward" value="<?php echo $operator_config['store_withdrawals_operator_reward']; ?>" class="input-txt" type="text"> ‰给予奖励</p>
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="reg_integral">股东奖励设置</label>
                </dt>
                <dd class="opt">

                    <p>店铺提现的<input name="withdraw_fee" value="<?php echo $store_config['withdraw_fee']; ?>" class="input-txt" type="text"> %

                        中的<input id="service_ratio" name="store_withdrawals_shareholder_reward" value="<?php echo $operator_config['store_withdrawals_shareholder_reward']; ?>" class="input-txt" type="text"> ‰给予奖励</p>
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="reg_integral">运营商提现手续费</label>
                </dt>
                <dd class="opt">
                    ...
                    <input id="max_service_money" name="operator_withdrawals" value="<?php echo $operator_config['operator_withdrawals']; ?>" class="input-txt" type="text">%
