<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view/store\editGoods.html";i:1566371889;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div id="goods_release" style="display: none;">
    <input type="hidden" name="goods_id" value="<?php echo \think\Request::instance()->get('id'); ?>">
        ...
        <div class="offline_price_content bgcolor mt24">
            ...
            <div class="offline_original_price release_item release_border">
                ...
                <div class="item_right">
                    ...
                    <span class="date_price" style="visibility:hidden;cursor: default;">按日期定价 ></span>
                </div>
            </div>
    ...
    <!--上传-->
    <div class="goods_submit_btn" id="edit_btn">确认上传</div>
</div>
</body>
<!--类别-->
<div id="category">
...
<div id="all_set">
    <div class="set_item">
        <p>批量设置价格</p>
        <input class="set_price" type="text" maxlength="30" placeholder="请输入" />
    </div>
    <div class="set_item">
        <p>批量设置库存</p>
...
<script type="text/javascript">
    ...
    if (localStorage.getItem('type') == 'offlin') {
        ...
        if (localStorage.getItem('catId') == 1223) {
            $.ajax({
                type: 'GET',
                ...
                success: function(res){
                    ...
                    if (res.code == 200) {
                        ...
                        $('#firstSelect').calendarSwitch({
                            ...
                            startDate: msg.start_time,   // 入住时间
                            endDate: msg.end_time,   // 离店时间
                            outNum: leng, // 共几晚
...
<script type="text/javascript" src="/public/static/js/store/editGoods.js"></script>
</html>