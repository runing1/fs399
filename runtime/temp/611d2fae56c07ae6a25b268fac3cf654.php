<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view/operator\index.html";i:1565666495;s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\layout.html";i:1558323298;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <select class="select" name="search_type" id="search_type">
                            <option value="user_name">运营商昵称</option>
                            <!--<option value="search_key">运营商账户</option>-->
                        </select>
                        <input type="text" id="search_key" name="search_keywords" size="30" class="qsbox" placeholder="查询"
                               value="">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="left" abbr="user_name" axis="col4" class="">
                            <div style="text-align: center; width: 150px;" class="">运营商昵称</div>
                        </th>
                        <th align="center" abbr="level" axis="col5" class="">
                            <div style="text-align: center; width:150px;" class="">运营商地址</div>
                        </th>
                        <th align="center" abbr="total_amount" axis="col6" class="">
                            <div style="text-align: center; width:150px;" class="">运营商类型</div>
                        </th>
                        ...
                        <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 150px;" class="">账户余额</div>
                        </th>
                        <th align="center" abbr="funds" axis="col6" class="">
                            <div style="text-align: center; width: 150px;" class="">店铺余额</div>
                        </th>
                        <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 150px;" class="">缴费金额</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Operator/admin_info'); ?>">
                        <div class="add" title="添加运营商">
                            <span><i class="fa fa-plus"></i>添加运营商</span>
                        </div>
                    </a>
                ...
                <div class="fbutton">
                    <a href="javascript:;" onclick="exportUser()">
                        <div class="add" title="导出会员">
                            <span><i class="fa fa-share"></i>导出运营商</span>
                        </div>
                    </a>
                </div>
                <!--<div class="fbutton">-->
...
<script>
    ...
    function ajax_get_table(tab,page){
        ...
        $.ajax({
            type : "POST",
            url:"/index.php/Admin/Operator/ajaxindex/p/"+page,//+tab,
