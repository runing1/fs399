<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/system\shop_info.html";i:1566468522;s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\layout.html";i:1558323298;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" id="handlepost" action="<?php echo U('System/handle'); ?>" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
            ...
            <!--<dl class="row">-->
                ...
                <!--</dt>-->
                <!--<dd class="opt">-->
                    <!--<input id="phone" name="phone" value="<?php echo $config['phone']; ?>" class="input-txt" type="text" onblur="checkPhone()"/>-->
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic">客户端显示，方便商家遇到问题时咨询</p>
                </dd>
            </dl>
            <!--<dl class="row">-->
                <!--<dt class="tit">-->
