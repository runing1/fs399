<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view/user\team_member.html";i:1565949563;s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\layout.html";i:1558323298;}*/ ?>
<!doctype html>
<html>
<head>
...
<script>
    layui.use('table', function(){
        ...
        table.render({
            elem: '#team_member'
            ,cellMinWidth: 80
            ,url: "<?php echo U('User/ajaxteam_member'); ?>"//数据接口
