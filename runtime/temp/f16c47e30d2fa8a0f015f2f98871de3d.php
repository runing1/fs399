<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/user\message.html";i:1566202615;s:98:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\layout.html";i:1558323298;}*/ ?>
...
<script>
    function deleteMessage(obj,id){
        layer.confirm('确定要删除吗？', {
                ...
                // 确定
                $.ajax({
                    url: "<?php echo U('User/deleteMessage'); ?>",
                    type: 'post',
                    data: {id:id},
                    dataType: 'JSON',
                    success: function (data) {
