<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/index\index.html";i:1566893677;s:96:"D:\PhpStudy20180211\PHPTutorial\WWW\TPshop\TPshop_V2.5.2\application\admin\view\public\left.html";i:1563519942;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('storeManage|Store');">
    <img  style="width: 148px;height: 28px;cursor: pointer;" src="<?php echo (isset($tpshop_config['shop_info_admin_home_logo']) && ($tpshop_config['shop_info_admin_home_logo'] !== '')?$tpshop_config['shop_info_admin_home_logo']:'/public/static/images/logo/admin_fs399_logo.png'); ?>" alt="">
  </div>
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <!--服务器升级 end-->
      <dl>
        <a href="javascript:void(0);" style="color: #fff;" onClick="openItem('message|User')">
          <dt class="name"></dt>
          <i class="layui-icon layui-icon-notice" style="font-size: 22px; color: #xe667;"></i>
          <?php if($unread != 0): ?><span class="badge badge-danger" style="background-color: #ed5565; color: #FFF;float: right;border-radius:20px;"><?php echo $unread; ?></span><?php endif; ?>
        </a>
      ...
      <dl>
          <a href="" style="color: #fff;" target="_blank">
            <dt class="name"></dt>
            <dd class="group"><?php echo $admin_info['province']; ?><?php echo $admin_info['city']; ?><?php echo $admin_info['district']; ?></dd>
            <?php switch($admin_info['operator_type']): case "1": ?>县运营商<?php break; case "2": ?>股东<?php break; case "3": ?>核心股东<?php break; default: ?>管理员
            <?php endswitch; ?>
          </a>
      </dl>    
      <dl>
      ...
      <div class="manager-menu">
        ...
        <div class="title">
          <h4>常用操作</h4>
          <!--<a href="javascript:void(0)" onClick="openItem('publishGoods|Publish')" class="add-menu">添加菜单</a> -->
        </div>
    ...
    <ul class="operate nc-row">
      ...
      <!-- li><a class="style-color show-option" id="trace_show" href="javascript:void(0);" title="给管理中心换个颜色">&nbsp;</a></li -->
        <li><a class="sitemap show-option" id="trace_show" href="<?php echo U('System/cleanCache',array('quick'=>1)); ?>" target="workspace" title="更新缓存">&nbsp;</a></li>
...
<div class="admincp-container-left">
    ...
    <?php endforeach; endif; else: echo "" ;endif; ?> 
    <div class="about" title="关于系统" onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'<?php echo U("Index/about"); ?>', });"><i class="fa fa-copyright"></i><span>fs399.cn</span></div>
</div>
