...
//        if ($inc_type == 'withdrawals') {
//            //获取店铺配置及运营商
//            $store_config = M('store_config')->find(1);
//            // var_dump($store_config);die;
//            $operator_config = M('operator_config')->find(1);
//            //   var_dump($operatorconfig);die;
//
...
//        }
    ...
    public function handle()
    {
        ...
        switch ($inc_type) {
            case 'withdrawals':
                //接收store的参数
                $data_store['year_fee'] = $param['year_fee'];
                $data_store['season_fee'] = $param['season_fee'];
                $data_store['mid_year_fee'] = $param['mid_year_fee'];
                $data_store['withdraw_fee'] = $param['withdraw_fee'];
                M('store_config')->where('id=1')->save($data_store);
                //运营商
                $data_operator['store_season_reward'] = $param['store_season_reward'];
                $data_operator['store_mid_year_reward'] = $param['store_mid_year_reward'];
                $data_operator['store_year_reward'] = $param['store_year_reward'];

                M('operator_config')->where('id=1')->save($data_operator);
                $this->success("操作成功", U('System/index', array('inc_type' => $inc_type)));
                break;
            case 'cash':
                $data_operator['min_cash'] = $param['min_cash'];
                M('operator_config')->where('id=1')->save($data_operator);
                $this->success("操作成功", U('System/index', array('inc_type' => $inc_type)));
                break;
...
//        if ($inc_type == 'withdrawals') {
//            //接收store的参数
//            $data_store['year_fee']=$param['storeyear_fee'];
//            $data_store['month_fee']=$param['storemonth_fee'];
//            $data_store['withdraw_fee']=$param['store_withdraw_fee'];
//            M('store_config')->where('id=1')->save($data_store);
//            //运营商
//            $data_operator['store_year_cityreward']=$param['store_year_cityreward'];
//            $data_operator['store_month_cityreward']=$param['store_month_cityreward'];
//            $data_operator['store_year_countyreward']=$param['store_year_countyreward'];
//            $data_operator['store_month_countyreward']=$param['store_month_countyreward'];
//            $data_operator['store_withdrawals_cityreward']=$param['store_withdrawals_cityreward'];
//            $data_operator['store_withdrawals_countyreward']=$param['store_withdrawals_countyreward'];
//            $data_operator['operator_withdrawals']=$param['operator_withdrawals'];
//
//            M('operator_config')->where('id=1')->save($data_operator);
//            $this->success("操作成功", U('System/index', array('inc_type' => $inc_type)));
//        } else {
...
//    }
    ...
    public function truncate_demo_data()
    {
        ...
        $bl_table = array('tp_admin','tp_config','tp_region','tp_system_module','tp_admin_operator_role','tp_system_menu','tp_article_cat','tp_article','tp_wx_user');
