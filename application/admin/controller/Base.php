...
//&&!in_array(CONTROLLER_NAME,array('Publish','Order','Store','Api','Goods','UnderLineIndex','UnderLine','Index'))
        //过滤不需要登陆的行为 
...
//        $this->page_size = C('PAGESIZE');
    ...
    public function check_priv()
    {
		...
		//无需验证的操作
		$uneed_check = array('login','logout','vertifyHandle','vertify','imageUp','upload','videoUp','delupload','login_task','welcome');
